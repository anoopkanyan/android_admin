...
public class ReadyShipmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ready_shipments);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            shipmentsAdapter = new ShipmentsAdapter(shipmentsList, ship_addr, ReadyShipmentsActivity.this);
