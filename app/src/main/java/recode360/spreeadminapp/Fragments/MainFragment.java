...
import recode360.spreeadminapp.Activities.ImageActivity;
...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ProgressDialog dialog = ProgressDialog.show(getActivity(), "", "Preparing..", true);
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                if (newProgress == 100) {
                    ...
                    mWebView.loadUrl("javascript:(function() { try{" +
                            ...
                            "document.getElementsByClassName('col-sm-3 col-md-2 hidden-xs sidebar')[0].style.display='none';" +
                            "document.getElementsByClassName('header logged-in')[0].style.display='none';" +
